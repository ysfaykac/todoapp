...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, List<String>>> handleJwtErrors(UserAlreadyExistsException ex) {
        List<String> errors = List.of(ex.getMessage());
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(errorsMap(errors));
    }
    @ExceptionHandler(JwtInvalidException.class)
    public ResponseEntity<Map<String, List<String>>> handleJwtErrors(JwtInvalidException ex) {
        List<String> errors = List.of(ex.getMessage());
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(errorsMap(errors));
    }
